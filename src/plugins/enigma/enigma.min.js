...
rcube_webmail.prototype.enigma_export=function(a){a=a?this.keys_list.get_selection().join(","):"*";a.length&&this.goto_url("plugin.enigmakeys",{_a:"export",_keys:a},!1,!0)};rcube_webmail.prototype.enigma_import=function(){var a,b;if(a=this.gui_objects.importform)(b=document.getElementById("rcmimportfile"))&&!b.value?alert(this.get_label("selectimportfile")):(b=this.set_busy(!0,"importwait"),a.action=this.add_url(a.action,"_unlock",b),a.submit(),this.lock_form(a,!0))};
